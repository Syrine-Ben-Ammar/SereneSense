...
class FeatureExtractor:
    ...
    def extract_features(self, audio: AudioData, config: Dict[str, Any]) -> torch.Tensor:
        """
        Compatibility method for legacy code.

        Args:
            audio: Input audio data
            config: Configuration dictionary with 'sample_rate' and optional 'feature_types'
        ...
        return self.extract(audio, sample_rate, feature_types)
